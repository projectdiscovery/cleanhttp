	...
	tests := []struct {
		...
		},
		{
			...
			response: Response{
				...
				RequestURL: "https://example.com:2052/",
			},
		...
		},
		{
			...
			response: Response{
				...
				RequestURL: "https://example.com:9999/",
			},
			want: nil,
		},
		{
		...
		{
			name: "cloudflare ports blocked waf match",
			response: Response{
				StatusCode: 403,
				Headers: map[string]string{
					"server":          "cloudflare",
					"cf-mitigated":    "challenge",
					"cf-ray":          "960c65a8ecd4826b-TPE",
			...
			want: []string{"cloudflare_ports_blocked_waf"},
		},
		{
			name: "cloudflare ports blocked waf - alternative title regex",
			response: Response{
				StatusCode: 403,
				Headers: map[string]string{
					"server": "cloudflare",
